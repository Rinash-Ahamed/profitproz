    ...
    <div className="min-h-screen bg-zinc-1000">
      ...
      <section className="relative min-h-[88svh] md:min-h-[96vh] flex flex-col justify-center pt-20 pb-12 md:pb-0 overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto w-full px-6 md:px-10">
          ...
          <a
            href="/contact"
            className="glow-green group inline-flex items-center justify-center gap-2 bg-[#66B159] hover:bg-[#73bd66] text-[#FFFCFC] font-sans font-semibold text-sm px-6 py-3 rounded-lg transition-colors duration-200 w-full sm:w-auto"
          >
